...
(function(GoogleAnalytics, ImageResource, Scroller, NativeProductOptionView, ProductOptionView, BuyItem, ShoppingCartData, ShoppingCartCollection, TouchWidget){
	...
	var productWidgetTemplate = [
		'<div class="product-box<% if(!img||img.length<3) print(\" noImg\"); %>">',
			...
			'</div>',
			'<div id="amount-panel">',
				'<div id="plusBtn" class="tag" style="background:url('+ImageResource["pic/type-tag"]+') repeat 0 0;"><div id="add-tag-inner" class="tag-inner">',
				...
				'</div></div>',
				'<div class="tag" style="background:url('+ImageResource["pic/type-tag"]+') repeat 0 0;"><div id="amount-tag-inner" class="tag-inner">',
					'<div id="amount-tag-content" class="tag-content">',
						'<div id="product-box-amount"><%= amount%></div>',
						'<div>份</div>',
					'</div>',
				'</div></div>',
				'<div class="tag" style="background:url('+ImageResource["pic/type-tag"]+') repeat 0 0;"><div id="total-tag-inner" class="tag-inner">',
					'<div id="total-tag-content" class="tag-content">',
						'<div style="font-size:0.9em">小計</div>',
						'<div id="product-box-total"><%= price*amount%></div>',
					'</div>',
				'</div></div>',
				'<div id="minusBtn" class="tag" style="background:url('+ImageResource["pic/type-tag"]+') repeat 0 0;"><div id="sub-tag-inner" class="tag-inner">',
			...
			'<div class="NoteBox AdditionBox">',
				'<div class="OptionPanel WebOptionPanel">',
					'<div class="OptionTitle">特殊需求</div>',
					'<div class="InputBox"><input type="Text" placeholder="加一顆糖一顆奶球" class="INPUT remarks" style="width=100%;"></div>',
				'</div>',
				'<div class="OptionPanel WebOptionPanel">',
					'<div class="OptionTitle">訂購者</div>',
					'<div class="InputBox"><input type="Text" placeholder="紀錄誰點了什麼，方便收錢" class="INPUT orderName" style="width=100%;"></div>',
				'</div>',
			'</div>',
		'</div>'
	].join('');
