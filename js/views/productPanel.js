		...
		'<div class="product-box<% if(!img||img.length<3) print(\" noImg\"); %>">',
			...
			'<div class="NoteBox">',
				'<div class="OptionPanel WebOptionPanel">',
					...
					'<div><input type="Text" placeholder="任何補充說明" class="INPUT remarks" style="width=100%;"></div>',
				'</div>',
				'<div class="OptionPanel WebOptionPanel">',
					'<div class="OptionTitle">訂購者</div>',
					'<div><input type="Text" placeholder="紀錄誰點了什麼，方便收錢" class="INPUT orderName" style="width=100%;"></div>',
				'</div>',
			'</div>',
		'</div>'
	].join('');
