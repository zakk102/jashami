...
(function(i18n, ImageResource, TabViews){
	var pageTemplate = [
		'<div class="PageLeftPanel" style="display:block; position:absolute; width:200px; -webkit-transition-property:-webkit-transform; -webkit-transition-duration:300ms; -webkit-transform:translate3d(-100%, 0px, 0px);">',
			'<div class="TabButton" href="orderTab"><span class="imgWrap"><img src="/jashami3/css/bootstrap/img/glyphicons_free/glyphicons/png/glyphicons_039_notes.png"></span>'+i18n._('orderTab')+'</div>',
			'<div class="TabButton" href="historyTab"><span class="imgWrap"><img src="/jashami3/css/bootstrap/img/glyphicons_free/glyphicons/png/glyphicons_039_notes.png"></span>'+i18n._('historyTab')+'</div>',
			'<div class="TabButton" href="feedbackTab"><span class="imgWrap"><img src="/jashami3/css/bootstrap/img/glyphicons_free/glyphicons/png/glyphicons_039_notes.png"></span>'+i18n._('feedbackTab')+'</div>',
			'<div class="TabButton" href="aboutUsTab"><span class="imgWrap"><img src="/jashami3/css/bootstrap/img/glyphicons_free/glyphicons/png/glyphicons_039_notes.png"></span>'+i18n._('aboutUsTab')+'</div>',
		'</div>',
