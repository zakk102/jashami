					...
					'<div class="header">',
						...
						'<div class="center" style="background:url('+ImageResource["pic/paper_light_yellow"]+') repeat scroll 0 0;">',
							...
							'<div class="function-panel">',
				                ...
				                '<a class="link" href="#startPage/feedbackTab"><div class="link-wrap" id="feedback-link-wrap"><div id="feedback-link" class="icon" style=" -webkit-mask-box-image:url('+ImageResource["css/bootstrap/img/glyphicons_free/glyphicons/png-square/glyphicons_309_comments"]+');"></div><div class="function-txt">有問題</div></div></a>',
								'<a class="link" href="#startPage/aboutUsTab"><div class="link-wrap" id="about-link-wrap"><div id="about-link" class="icon" style=" -webkit-mask-box-image:url('+ImageResource["css/icons/jashami-logo-toung"]+');"></div><div class="function-txt">教學</div></div></a>',
							'</div>',
