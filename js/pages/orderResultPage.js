				...
				'<div class="header">',
					'<div class="center">',
						...
						'<div class="NextButton" id="waiterBtn">',
							'<div class="link-wrap"><div id="back2order-link" class="icon"></div><div class="function-txt">回首頁</div></div>',					
						'</div>',
					'</div>',
				'</div>',
			'</div>',
